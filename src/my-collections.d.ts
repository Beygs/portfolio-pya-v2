...
export interface paths {
	...
	"/items/cv": {
		/**
		 * List Items
		 * @description List the cv items.
		 */
		get: operations["readItemsCV"];
		/**
		 * Create an Item
		 * @description Create a new cv item.
		 */
		post: operations["createItemsCV"];
		/**
		 * Delete Multiple Items
		 * @description Delete multiple existing cv items.
		 */
		delete: operations["deleteItemsCV"];
		/**
		 * Update Multiple Items
		 * @description Update multiple cv items at the same time.
		 */
		patch: operations["updateItemsCV"];
	};
	"/items/cv/{id}": {
		/**
		 * Retrieve an Item
		 * @description Retrieve a single cv item by unique identifier.
		 */
		get: operations["readSingleItemsCV"];
		/**
		 * Delete an Item
		 * @description Delete an existing cv item.
		 */
		delete: operations["deleteSingleItemsCV"];
		/**
		 * Update an Item
		 * @description Update an existing cv item.
		 */
		patch: operations["updateSingleItemsCV"];
	};
}
...
export interface components {
	schemas: {
		...
		ItemsProjects: {
			...
			date_updated?: string | null;
			title?: string | null;
			miniature?: string | components["schemas"]["Files"] | null;
			slug?: string | null;
		};
		ItemsCV: {
			id?: number;
			...
			pdf?: string | components["schemas"]["Files"] | null;
		};
	};
	responses: {
...
export interface operations {
	...
	readItemsCV: {
		...
		responses: {
			...
			200: {
				content: {
					"application/json": {
						data?: components["schemas"]["ItemsCV"];
						meta?: components["schemas"]["x-metadata"];
					};
				};
			};
	...
	createItemsCV: {
		...
		requestBody?: {
			content: {
				"application/json": components["schemas"]["ItemsCV"][] | components["schemas"]["ItemsCV"];
			};
		};
		responses: {
			/** @description Successful request */
	...
	updateSingleItemsCV: {
		...
		requestBody?: {
			content: {
				"application/json": components["schemas"]["ItemsCV"];
			};
		};
		responses: {
			/** @description Successful request */
